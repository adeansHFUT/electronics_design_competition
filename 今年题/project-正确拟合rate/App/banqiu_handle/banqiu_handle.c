...
void standing_point_init(void)
{
	...
	standing_point[1].x = 43;
	standing_point[1].y = 34;
	standing_point[2].number = 2;
	standing_point[2].x = 98;
	standing_point[2].y = 28;
	standing_point[3].number = 3;
	standing_point[3].x = 153;
	standing_point[3].y = 31;
	standing_point[4].number = 4;
	standing_point[4].x = 40;
	standing_point[4].y = 88;
	standing_point[5].number = 5;
	standing_point[5].x = 100;
	standing_point[5].y = 86;
	standing_point[6].number = 6;
	standing_point[6].x = 158;
	standing_point[6].y = 90;
	standing_point[7].number = 7;
	standing_point[7].x = 41;
	standing_point[7].y = 148;
	standing_point[8].number = 8;
	standing_point[8].x = 98;
	standing_point[8].y = 150;
	standing_point[9].number = 9;
	standing_point[9].x = 153;
	standing_point[9].y = 149;
}
